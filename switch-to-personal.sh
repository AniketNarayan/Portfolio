...
# Switch current repository to use personal GitHub account
...
# Set personal Git config for this repo
...
if git remote get-url origin &>/dev/null; then
    ...
    NEW_URL=$(echo "$CURRENT_URL" | sed 's/github\.com/github.com-personal/g' | sed 's/github\.com-work/github.com-personal/g')
    ...
    echo "   git remote add origin git@github.com-personal:username/repo.git"
fi
